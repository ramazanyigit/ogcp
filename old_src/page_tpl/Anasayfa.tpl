...
<tr>
<td><b><?=$a_player["name"]?></b></td>
<td style="text-align:center"><?=str_replace('l ','',$a_player["frag"])?></td>
<td style="text-align:center"><?=$a_player["ping"]?></td>
<td style="text-align:center"><?=str_replace('l ','',$a_player["loss"])?></td>
<td style="text-align:center"><?=str_replace('l ','',$a_player["adress"]) == "" ? "BOT" : str_replace('l ','',$a_player["adress"]) ?></td>
