...
<div class="widget-body">
	<table class="table table-striped">
		<tr><th style="text-align:right;width:150px;">Gönderen</th><th><?=$ticket["UserName"]?></th></tr>
...
<div class="widget-tickets widget-tickets-large clearfix">
	<ul>
		...
		<li class="priority-<?=$ticket_priclass[$ticket["TicketPriority"]]?>" style="border-bottom: 1px solid #DDDDDD;">
			<h5 style="color:black"><?=$message["UserName"]?></h5>
		...
		<form method="POST" action="<?=$page->CreatePageLink($cur_page,'ID='.$_GET["ID"])?>">
		    ...
		    <div class="control-group">
                    <div class="controls" align="center">
						<input type="checkbox" name="durum" style="margin-top:-4px;" /> Bildirimi Kapat (Mesaj boş ise Kapatıldı yazar!) <br/>
						<br/>
