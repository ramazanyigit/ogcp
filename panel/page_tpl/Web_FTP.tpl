...
<td>Dosya Yükle:</td><td style="padding-top:0px; padding-bottom:0px;"><input name="dosya1" type="file" /></td><td colspan=2><input class="btn btn-inverse" type="submit" name="yukle" /></td>
</form>
</tr>
<tr>
