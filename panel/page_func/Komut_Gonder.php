<?php
	...
	if(isset($_POST["yardir"])) {
		$_POST["komut"] = addslashes($_POST["komut"]);
		$durum = false;
		$bad_commands = array(
			"sv_password","sv_downloadurl","hostname","rcon_password","sv_contact","sv_maxrate","sv_minrate","sv_maxupdaterate","sv_minupdaterate","sys_ticrate","fps_max","fps_modem"
		);
